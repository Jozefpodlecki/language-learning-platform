...
import { faArrowCircleRight, faArrowCircleLeft, faArrowsAltV, faVolumeUp } from "@fortawesome/free-solid-svg-icons";
import { getCourseAsync, getCourseDatasetAsync, getCourseMetadataAsync } from "api";
...
const CourseFlashcards: FunctionComponent = () => {
    ...
    useEffect(() => {
        ...
        if(metadata.isLoading === true || metadata.courseId !== courseId) {
            getCourseMetadataAsync(courseId)
                .then(metadata => {
            ...
            <div className={style.flashcard}>
                <div className={style.wrapper}>
                    <div>
                        ...
                        </div> : <div className={style.key}>{key}</div>}
                        <div>
                            <div className={style.button} onClick={onPlayAudio}>
